...
type PassWordCheckInfo struct {
	...
	PassWord          string `protobuf:"bytes,1,opt,name=passWord,proto3" json:"passWord,omitempty"`                   // 真实密码
	EncryptedPassWord string `protobuf:"bytes,2,opt,name=encryptedPassWord,proto3" json:"encryptedPassWord,omitempty"` // 盐值加密后的密码
}
...
type UserListResponse struct {
	...
	Data  []*UserInfoResponse `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"` // 内嵌用户信息
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x44, 0x61, 0x79, 0x22, 0x5d, 0x0a, 0x11, 0x50, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72,
	...
	0x57, 0x6f, 0x72, 0x64, 0x22, 0xba, 0x01, 0x0a, 0x10, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x2e, 0x3b, 0x70, 0x72, 0x6f,
